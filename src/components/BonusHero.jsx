            ...
            <div className="hidden lg:block">
              <section id="getstarted" className="relative text-white py-[100px] px-10 md:px-12 flex flex-col lg:flex-row items-center justify-between">
                ...
                <div className="lg:w-1/2 text-center lg:text-left">
                    ...
                    >
                        Τύποι μπόνους στο καζίνο Frumzi
                    </motion.h1>
                    <p className="text-md md:text-md xl:text-lg mb-6 opacity-90 pr-6">
                    Το Frumzi Casino προσφέρει μια ποικιλία μπόνους στους παίκτες του, ενισχύοντας τη συνολική εμπειρία παιχνιδιού. Αυτά τα μπόνους καλύπτουν διαφορετικές προτιμήσεις και στυλ παιχνιδιού, παρέχοντας στους παίκτες πρόσθετη αξία. Από Μπόνους καλωσορίσματος έως προγράμματα VIP, Το Frumzi στοχεύει να προσελκύσει και να διατηρήσει μια διαφορετική βάση παικτών προσφέροντας κίνητρα σε διάφορες κατηγορίες παιχνιδιών.
                    </p>
                ...
                >
                    <motion.img
                        src={screen7}
                        alt="Frumzi"
                        className="w-full max-w-md sm:max-w-lg md:max-w-lg lg:max-w-lg xl:max-w-lg rounded-xl shadow-2xl border border-gray-200 cursor-pointer hover:shadow-[0_0_10px_rgb(255,255,255)] hover:duration-300"
                        style={{
                            rotateX,
                            rotateY,
